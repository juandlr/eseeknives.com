...
/**
 * Store Locator Configuration Form.
 *
...
class StoreLocatorConfigurationForm extends ConfigFormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('store_locator.settings')
      ->set('marker_width', $form_state->getValue('width'))
      ->save();
    $this->config('store_locator.settings')
      ->set('marker_height', $form_state->getValue('height'))
      ->save();
    $this->config('store_locator.settings')
      ->set('api_key', $form_state->getValue('api_key'))
      ->save();
    $this->config('store_locator.settings')
      ->set('infowindow', $form_state->getValue('setting_infowindow'))
      ->save();
    $this->config('store_locator.settings')
      ->set('infowindow_direction', $form_state->getValue('setting_infowindow_direction'))
      ->save();
    $this->config('store_locator.settings')
      ->set('list', $form_state->getValue('setting_list'))
      ->save();
    $this->config('store_locator.settings')
      ->set('list_direction', $form_state->getValue('setting_list_direction'))
      ->save();
    $this->config('store_locator.settings')
      ->set('title', $form_state->getValue('store_label'))
      ->save();
    $this->config('store_locator.settings')
      ->set('message', $form_state->getValue('store_text'))
      ->save();
    $this->config('store_locator.settings')
      ->set('logo_style', $form_state->getValue('logo'))
      ->save();
