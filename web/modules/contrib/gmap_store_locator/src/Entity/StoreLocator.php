 ...
 *   },
 *   links = {
 *     "canonical" = "/store-locator/{store_locator}",
 *     "add-form" = "/admin/store-locator/add",
 *     "edit-form" = "/admin/store-locator/{store_locator}/edit",
 *     "delete-form" = "/admin/store-locator/{store_locator}/delete",
 *     "collection" = "/admin/store-locator/list",
 *   },
